                                ...
                                <div class="col-lg">
                                    <div class="p-4">
                                        <div class="text-center">
                                            <h1 class="h6 text-gray-900">Change your password for</h1>
                                            <h6 class="mb-2"><?= $this->session->userdata('reset_email'); ?></h6>
                                        </div>
                                        <?= $this->session->flashdata('message'); ?>
                                        <form class="user" method="post" action="<?= base_url('frontend/auth/changepassword'); ?>">
