                        ...
                        <div class="card-body text-lg-left">
                            ...
                            <div class="row">
                                ...
                                <div>
                                    ...
                                    <p class="lead text-gray-800 mb-1 font-italic"><a href="<?= base_url('frontend/auth/verify?email='); ?><?= $emailTo; ?>&token=<?= urlencode($token); ?> ">&raquo verify to activation here &laquo</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
