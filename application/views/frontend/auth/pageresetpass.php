<!-- Page Wrapper -->
<div id="wrapper" class="container mt-5 bg-primary">
    <!-- Content Wrapper -->
    <div id="content-wrapper" class="d-flex flex-column">

        <!-- Main Content -->
        <div class="text-center bg-success" id="content">
            <!-- Begin Page Content -->
                        ...
                        <div class="card-body text-lg-left">
                            ...
                            <div class="row">
                                ...
                                <div>
                                    ...
                                    <p class="lead text-gray-800 mb-1 font-italic"><a href="<?= base_url('frontend/auth/resetPassword?email='); ?><?= $emailTo; ?>&token=<?= urlencode($token); ?> ">&raquo reset password here &laquo</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
